...
@section('content')
    ...
    <div class="container " id="custom-cards">
        ...
        <form method="post" action="{{route('create-new-bicycle')}}" class="m-auto form-signin" style="width:auto"
            ...
            <input name="bicycle_name" type="text" placeholder="Bicycle name" class="mb-4 form-control"
            ...
            <div class="container mb-4">
                ...
                @foreach($all_manufacturers as $manufacturers)
                    <div class="form-check">
                        <input class="form-check-input fs-4" type="radio" value="{{ $manufacturers->manufacturer_id}}"
                               name="manufacturerid" required>
                        <label class="form-check-label"
                               for="flexRadioDefault1">{{$manufacturers->manufacturer_name}}</label>
            ...
            <textarea class="mb-4 form-control" rows="4" style="height: auto;" name="bike_description"
                      required></textarea>
