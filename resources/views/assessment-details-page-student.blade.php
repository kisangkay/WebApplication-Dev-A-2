        ...
        <div class="form-group">
            ...
            @foreach($myreviews as $individual_review)
                ...
                <div class=" text-center d-flex justify-content-center">
                    <a class="w-50 list-group list-group-item list-group-item-action list-group-item-info text-light" style="background-color: #087990">Review from {{$individual_review->reviewer->fullname}}</a>
                </div>
