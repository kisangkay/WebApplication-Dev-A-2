<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="user_number" :value="__('Usernumber')" />
            <x-text-input id="user_number" name="user_number" type="number" class="mt-1 block w-full" :value="old('user_number', $user->user_number)" required autofocus autocomplete="usernumber" />
