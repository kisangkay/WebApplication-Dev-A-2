...
{{--                    <small class="fw-bold text-info">Posted by: {{$bike->username}}</small>--}}
                ...
                <ul class="mt-3 list-group border border-info">
                    <li class="d-flex justify-content-center text-warning list-group-item"><strong>Average Rating: </strong></li>
                    <li class="d-flex justify-content-center list-group-item"><strong class="list-unstyled">Total Reviews: {{$bike->bicycle_total_reviews}}</strong></li>
                    </li>
                </ul>
