    ...
    <div class="container ">
        ...
        <form method="post" action="{{route('update-assessment-details',['cid' => $cid, 'assesst_id' => $assesst_id])}}" class="m-auto" style="width:auto" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control w-25 mb-4 border-success border-2" id="duedate" name="due_date" value="{{$assesst_details->due_date}}" type="datetime-local">

                <label class="h4" for="reviewsno">Number of Reviews Required</label>
                <input class="form-control w-25 border-success border-2 mb-4" id="reviewsno" name="reviews_required" value="{{$assesst_details->number_reviews_required}}" type="number">

                <label class="h4" for="maxscore">Maximum Score</label>
                <input class="form-control w-25 border-success border-2 mb-4" id="maxscore" name="max_score" value="{{$assesst_details->max_score}}" type="number">
            </div>

            <div class="d-flex justify-content-center">
                @if($isthereanyreview)
                    <button class=" btn btn-success w-50 mb-4 bi bi-pen" type="submit" disabled> Edit Assessment</button>
                @else
